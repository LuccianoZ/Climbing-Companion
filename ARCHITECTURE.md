...
| ------------ | --------- | ------ |
| `map-ui.feature` | 14 | Epic 4 (unchanged from AR-21, bar one step: a crag panel now offers three actions, not four — AR-36) |
| `auth-ui.feature` | 11 | BL-001–004 |
| `submission-ui.feature` | 10 | BL-006/007, BL-023 |
| `verification-ui.feature` | 11 | BL-008/009/010/011/014 |
