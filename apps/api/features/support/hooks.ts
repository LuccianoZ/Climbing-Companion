...
Before(async function (this: AuthWorld) {
  ...
  await dataSource.query(
    'TRUNCATE TABLE "users", "crags", "routes", "gyms", "media_assets", "route_verifications", "route_grade_votes", "gym_verifications", "gym_information_disputes", "climb_logs", "gym_checkins", "gym_badges", "gym_streaks", "friendships", "friend_invite_links", "reviews", "media_reports", "media_moderation_actions", "user_accountability_actions", "notifications" CASCADE',
  );
});
